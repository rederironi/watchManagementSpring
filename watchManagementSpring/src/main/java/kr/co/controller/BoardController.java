...
public class BoardController {
	 ...
	 * 
	 * @RequestMapping(value = "/list", method = RequestMethod.GET) public String
	 * list(Model model, Criteria cri) throws Exception{ logger.info("list");
	 * 
	 ...
	 * String read(BoardVO boardVO, Model model) throws Exception{
	 * logger.info("read");
	 * 
	 ...
	 * delete(BoardVO boardVO) throws Exception{ logger.info("delete");
	 * 
