								...
								<form role="form" method="get">
									<table class="sui-table sui-hover sui-selectable">
										...
										<c:forEach items="${list}" var = "list">
											<tr class="sui-row" role="row" style="cursor:pointer;" onclick="location.href='/board/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'">
