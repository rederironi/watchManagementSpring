							...
							<div class="sui-gridcontent">
								<form role="form" method="get">
									<table class="sui-table sui-hover sui-selectable">
										...
										<tr class="sui-row" role="row" style="cursor:pointer;" onclick="location.href='/exception/readView?eno=${list.eno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'">
